...
Within OPH, that census is uneven. Some particles sit on exact structural or exact-sidecar surfaces (photon, gluons, graviton, W, Z). The Higgs/top lane and the neutrino lane have explicit quantitative outputs. Quarks and charged leptons sit on narrower intermediate surfaces, and composite particles like hadrons require computational work beyond the symbolic framework.
