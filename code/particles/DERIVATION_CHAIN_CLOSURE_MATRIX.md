...
| `electroweak_wz` | `compare_only_reproduction_not_prediction_theorem` | `False` | none | `w_boson=80.377`, `z_boson=91.18797809193725` | code/P_derivation/runtime/r_q_residual_contract_current.json |
