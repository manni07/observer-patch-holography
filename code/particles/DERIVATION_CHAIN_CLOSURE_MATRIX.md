...
Reason: Hadron issues #153/#157 are closed out-of-scope pending OPH hadron hardware; the remaining in-scope open P/electroweak chains need local theorem packets before worker audit is meaningful. The charged absolute-anchor, quark global-classification, and direct-top auxiliary-codomain lanes have corpus-limited no-go boundaries.
