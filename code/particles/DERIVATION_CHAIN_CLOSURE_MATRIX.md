...
| --- | --- | --- | --- | --- | --- |
| `p_closure_root` | `candidate_not_certified_root` | `False` | #224 | `P=1.63097210492078846050203640439`, `alpha_inv=136.994020662724205139718642793` | code/P_derivation/runtime/r_q_residual_contract_current.json + code/P_derivation/runtime/fine_structure_interval_certificate_current.json |
| `structural_massless_bosons` | `closed_structural_zero` | `True` | none | `photon=0.0`, `gluon=0.0`, `graviton=0.0` | none |
| `electroweak_wz` | `compare_only_reproduction_not_prediction_theorem` | `False` | #224 | `w_boson=80.377`, `z_boson=91.18797809193725` | code/P_derivation/runtime/r_q_residual_contract_current.json |
