...
Phase I. In particular, this appendix does not prove that OPH has already derived the physical
...
\]
On the live D10 branch these are the branch values \((M_U(P),\alpha_U(P))\) emitted by the forward
...
the plain SM coefficients. On this D10 branch this remains a benchmark matched by the D10
...
The missing bridge to theorem-level unification closure is explicit. One still needs a derived
