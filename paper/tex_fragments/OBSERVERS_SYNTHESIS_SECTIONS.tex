...
inconsistency potential on every touched overlap set, and the repair relation is locally
confluent, then every initial configuration has a unique schedule-independent normal form.
