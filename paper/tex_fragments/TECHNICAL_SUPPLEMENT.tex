...
\textbf{Consequence.} The present condition package proves the fixed-cutoff strip bridge through the weak tail generator \(q(a,\Omega)\), derives half-sided modular inclusion on the null half-line blow-up net, and therefore obtains a genuine positive null translation generator by Borchers--Wiesbrock. The remaining downstream burdens are the density-upgrade hypotheses and the relativistic EFT null-stress premise. Those later steps are explicit rather than hidden parts of N1--N3.
