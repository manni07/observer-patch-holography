...
\textbf{Geometric modular flow:} On the explicit \textbf{T1}+\textbf{T3} BW/geometric branch, cap modular flow is the standard conformal dilation with the \(2\pi\) normalization. OPH does not currently derive that branch from MaxEnt alone, and Euclidean-regularity is not part of the present theorem contract.
