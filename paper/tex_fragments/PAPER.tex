...
In particular, D3--D5 are scaling-limit branches rather than fixed-cutoff matrix-algebra theorems; D7--D9 are realized-branch structural outputs in the bosonic internal-gauge sector; D6 is the input-dependent global closure of the D5 Einstein branch; and D12 remains phenomenological.
...
\textbf{D6} & input-dependent global closure of the Einstein branch for \(\Lambda\), plus a legacy capacity-level neutrino side estimate & de Sitter entropy relation and dimensional analysis & external input \(N_{\mathrm{scr}}\) and the screen-capacity identification & Phase II input-dependent global closure / estimate \\
