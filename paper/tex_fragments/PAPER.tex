...
and controlled on the declared Petz domain. The declared touched-overlap acceptance contract is
already what makes \(\Phi\) the finite-patch Lyapunov functional for accepted moves.
