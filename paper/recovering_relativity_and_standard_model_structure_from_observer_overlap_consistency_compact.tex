...
The framework is presented as a reconstruction program in which general relativity and the Standard Model appear as effective sectors derived from the stated quantum-algebraic axiom set together with an explicit refinement/scaling-limit package. This theory-of-everything framing is a claim about recovering the observed effective universe from that package and its declared branch premises, not a claim that the present paper has already reconstructed the quantum formalism from a pre-quantum substrate.
