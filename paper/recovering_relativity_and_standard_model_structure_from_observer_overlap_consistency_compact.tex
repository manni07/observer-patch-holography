...
\bottomrule
\endfoot
\textbf{D1} & Unique schedule-independent normal form for the declared recovery-derived repair relation (Theorem~\ref{thm:confluence}) & overlap-consistency problem on a finite patch net together with the declared fixed-cutoff collar recovery step & Newman's lemma for terminating locally confluent repair relations & finite state spaces, repair completeness, termination, and local confluence on the declared recovery branch & Phase I structural theorem \\
...
\bottomrule
\endfoot
\textbf{D1} & Theorem~\ref{thm:confluence}: unique normal form and schedule independence for the declared recovery-derived repair relation & overlap-consistency problem on a finite patch net together with the declared fixed-cutoff collar recovery step & Newman's lemma for terminating locally confluent repair relations & finite state spaces, repair completeness, termination, and local confluence on the declared recovery branch & structural theorem \\
...
completeness together with the \(\Phi\)-decrease and local-confluence hypotheses on the declared
branch, and the Petz support/CPTP clause where that branch is used.
