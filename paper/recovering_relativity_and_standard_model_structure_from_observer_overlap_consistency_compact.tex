...
\textbf{D6} & Input-dependent global closure of the Einstein branch for \(\Lambda\), plus a legacy capacity-level neutrino side estimate (Proposition~\ref{prop:lambda}, Corollaries~\ref{cor:lambda}, \ref{cor:lambda-global}) & D5 local Einstein recovery leaves a \(+\Lambda g_{ab}\) ambiguity & de Sitter entropy relation and dimensional analysis & external input \(N_{\mathrm{scr}}\) and the screen-capacity identification & Phase II input-dependent global closure / estimate \\
...
\textbf{D6} & Proposition~\ref{prop:lambda}, Corollaries~\ref{cor:lambda}, \ref{cor:lambda-global}: input-dependent global closure of the Einstein branch for \(\Lambda\), plus a legacy neutrino side estimate & D5 local Einstein recovery, which leaves the \(+\Lambda g_{ab}\) ambiguity & de Sitter entropy relation and dimensional analysis & external input \(N_{\mathrm{scr}}\) and the screen-capacity identification & input-dependent global closure / estimate \\
...
Proposition~\ref{prop:lambda} and Corollaries~\ref{cor:lambda}, \ref{cor:lambda-global} are the intended local/global D6 stack: local null-modular reconstruction leaves the Einstein equation determined only up to a metric term, the global screen-capacity identification fixes the remaining constant, and the same Einstein branch then closes globally once \(N_{\mathrm{scr}}\) is declared. This is a structural aspect of the framework. The vacuum-energy problem is reorganized by separating local null data from the global capacity closure.
