...
when closure holds, Lyapunov descent with derived termination, local confluence, schedule robustness, normal-form
...
beyond those branches is the next layer only: Lyapunov descent with derived termination, local confluence,
