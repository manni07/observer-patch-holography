...
\midrule
\(P\)-closure root & candidate root, not certified & no & source spectral measure payload + interval certificate & \(P=1.63097210492078846050203640439\), \(\alpha^{-1}_{\mathrm{cand}}=136.994020662724205139718642793\) \\
...
\[
\Delta_{\mathrm{source}}(P)=0.041465861005223389065796874868111808\ldots.
\]
