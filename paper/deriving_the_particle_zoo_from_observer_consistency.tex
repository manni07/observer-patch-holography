...
\item compact gauge reconstruction from the transportable edge-sector colimit once its directed-colimit, symmetry, and fiber-functor premises are supplied;
...
explicit colimit, symmetry, and fiber-functor premises are supplied, organize into a compact gauge
...
explicit colimit, symmetry, and fiber-functor premises'' into the realized Standard Model branch. This
...
scope, the theorem-local equilibrium input used in the Jacobson step, and the transportable
directed-colimit, symmetry, and bosonic fiber-functor clauses required by compact-gauge
...
explicit transportable-colimit, \(3+1\)D symmetry, and fiber-functor premises and only then applies MAR to
