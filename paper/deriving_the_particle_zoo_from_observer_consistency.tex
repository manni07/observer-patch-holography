...
Neutrinos & continuation & weighted-cycle PMNS/hierarchy closure & no promoted masses & one residual bridge scalar \(B_\nu\) remains open; \(\lambda_\nu\) is induced only after exact \(q_{\mathrm{mean}}^{p_\nu}\) factorization, the sharpened target-containing compare-only corridor is \([6.69600,6.71040]\), and absolute masses and absolute \(\Delta m^2\) remain compare-only until that bridge law is emitted \\
