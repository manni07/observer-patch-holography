...
\midrule
\(P\)-closure root & candidate root, not certified & no & \#224 plus source-spectral stage gate & \(P=1.63097210492078846050203640439\), \(\alpha^{-1}_{\mathrm{cand}}=136.994020662724205139718642793\) \\
Structural massless carriers & closed structural zero & yes & none & \(m_\gamma=m_g=m_{\mathrm{grav}}=0\) \\
Electroweak \(W/Z\) & compare-only frozen adapter, not a prediction theorem & no & \#224 plus source-spectral stage gate & \(80.377~\mathrm{GeV}\), \(91.18797809193725~\mathrm{GeV}\) \\
