...
promoted from candidate metadata to a live prediction root. The pipeline records the candidate
value
\[
...
\]
and keeps it outside live particle predictions pending the Ward-projected Thomson endpoint and
RG/matching interval gates. The
...
\]
The reason is mechanical: the same branch depends on the non-live \(P\) root, the open
